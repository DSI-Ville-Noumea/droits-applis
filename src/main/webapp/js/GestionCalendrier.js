//***********************************************************
//  Debut Insertion by Luc de calendar.js
//***********************************************************
...
if (b[i] == "y") {
//Modified BY LUC			y = a[i];
			if (parseInt(a[i]) <= 40) {
				y = parseInt(a[i]) % 100 + 2000;
			} else if (parseInt(a[i]) < 100 ) {
				y = parseInt(a[i]) % 100 + 1900;
			} else {
				y = parseInt(a[i]);
			}
		...
		if (b[i] == "yy") {
//Modified BY LUC			y = parseInt(a[i]) + 1900;
			if (parseInt(a[i]) <= 40) {
				y = parseInt(a[i]) % 100 + 2000;
			} else if (parseInt(a[i]) < 100 ) {
				y = parseInt(a[i]) % 100 + 1900;
...
//***********************************************************
//  Fin Insertion by Luc de calendar.js
//***********************************************************


//***********************************************************
//  Debut Insertion by Luc de la version fr (calendar-fr.js)
//***********************************************************
...
//***********************************************************
//  Fin Insertion by Luc de la version fr (calendar-fr.js)
//***********************************************************
